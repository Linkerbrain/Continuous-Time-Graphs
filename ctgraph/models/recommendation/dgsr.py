...
# beast mode
python main.py --dataset beauty train --accelerator gpu --devices 1 --val_epochs 3 --epochs 50 --batch_size 50 --batch_accum 1 DGSR --train_style dgsr_softmax --embedding_size 50 --num_DGRN_layers=2 --val_extra_n_vals 1 --loss_fn ce neighbour --newsampler --sample_all --n_max_trans 50 --m_order 1 --num_user 100
